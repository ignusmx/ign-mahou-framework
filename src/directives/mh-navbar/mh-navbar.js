 ...
 * @property {MHAbstractUIElement[]}  mh-navbar-elements    - An array of {@link UIElements.MHButton MHButton} and {@link Models.MHDropdownButton MHDropdownButton} objects.
 * @property {string}  mh-navbar-title      - title of the navbar to be displayed
 * @property {function|string}  mh-navbar-title-action    - a function to be called or a ui-router state to transition to if user clicks navbar title
 * @description 
